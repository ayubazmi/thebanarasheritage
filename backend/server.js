...
// 6. Access Logs (New for Developer Settings)
...
app.get('/api/logs', async (req, res) => {
    // Return last 50 logs. Mocking data for now as middleware isn't persisting to DB yet for simplicity, 
    // or we can just mock it here for the UI demo.
    const mockLogs = [
