...
// --- New Feature: Dynamic Custom Page ---
  ...
  if (!page) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center text-center px-4">
        <h2 className="text-3xl font-serif text-brand-900 mb-2">Page Not Found</h2>
        <p className="text-gray-500 mb-6">The content you are looking for does not exist.</p>
